...
// Custom LinkedIn icon (cleaner design)
          ...
          <div className={`flex flex-row items-center gap-4 sm:gap-5 mb-6 transition-opacity duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
            ...
            >
              <Avatar className={`h-20 w-20 sm:h-24 sm:w-24 ring-2 shadow-lg ${isDark
                ...
                : 'ring-emerald-600/25 shadow-emerald-600/10'
                }`}>
          ...
          <div className={`flex items-center gap-2 transition-all duration-700 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            >
              <a href="https://linkedin.com/in/sewhail" target="_blank" rel="noopener noreferrer">
                <LinkedInIcon className="h-3 w-3 mr-1.5" />
                linkedin
              </a>
            </Button>
          </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                ...
                <div className="flex items-center gap-1">
                  {[
                    ...
                    { icon: LinkedInIcon, href: 'https://linkedin.com/in/sewhail' },
                  ].map(({ icon: Icon, href }) => (
                    <Button
                      key={href}
                      variant="ghost"
